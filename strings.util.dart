...
class StringUtils {
  ...
  /// Formatador para transformar um DateTime em extenso em português
  ...
  /// Método para transformar um double [number] em uma String formatada em um decimal customizavel.
  ///
  /// Exemplo de utilização:
  ///   ```dart
  ///     double d = 23.45;
  ///     StringUtils.numberToDecimal(d, 2) // "23,45"
  ///     StringUtils.numberToDecimal(d, 4) // "23,4500"
  ///     StringUtils.numberToDecimal(d, 6) // "23,450000"
  ///   ```
  static String numberToCustomDecimal(double number, int customDecimal) {
    final NumberFormat customFormatter = NumberFormat.decimalPatternDigits(
        locale: "pt_BR", decimalDigits: customDecimal);
  ...
  /// Método para transformar uma String [value] formata em valor (R$) em um valor double.
  ///
  /// Exemplo de utilização:
  ///   ```dart
  ///     String v = "R$ 23,45";
  ///     StringUtils.currencyToNumber(v) // 23.45
  ///   ```
  static double currencyToNumber(String value) {
    return currencyFormatter.parse(value).toDouble();
  }
  ...
  /// Método para transformar uma String [number] em um double de 4 casas
  /// decimais.
  ///
  /// Exemplo de utilização:
  ///   ```dart
  ///     String d = "23,4556";
  ///     StringUtils.stockToNumber(d) // 23.4556
  ///   ```
  static double stockToNumber(String number) {
    return stockFormatter.parse(number).toDouble();
  }
  ...
  /// Método para transformar uma String [number] customizavel em um double correspondente.
  ///
  /// Exemplo de utilização:
  ///   ```dart
  ///     String s = "10,56";
  ///     StringUtils.decimalToDouble(s, 2) // 10.56
  ///     String s = "10,5623";
  ///     StringUtils.decimalToDouble(s, 4) // 10.5623
  ///     String s = "10,562356";
  ///     StringUtils.decimalToDouble(s, 6) // 10.562356
  ///   ```
  static double customDecimalToDouble(String number, int customDecimal) {
    final NumberFormat customFormatter = NumberFormat.decimalPatternDigits(
        locale: "pt_BR", decimalDigits: customDecimal);
    return customFormatter.parse(number).toDouble();
  }
  ...
  ///   ```dart
  ///     (24/05/2024)
  ///     StringUtils.firstDayOfMonth(d) // DateTime(2024, 5, 1)
  ///   ```
  ...
  /// Método para validar um email [email].
  ///
  /// Exemplo de utilização:
  ///   ```dart
  ///     String email1 = "teste@teste";
  ///     StringUtils.isEmailValid(email1) // false
  ///   ```
  ///
  ///   ```dart
  ///     String email2 = "teste@teste.com";
  ///     StringUtils.isEmailValid(email2) // true
  ///   ```
