...
class RealmService {
  static final _config = Configuration.local(
    ...
    initialDataCallback: (realm) {
      realm.add<Estado>(Estado(ObjectId(), uf: "AC", nome: "Acre"));
      realm.add<Estado>(Estado(ObjectId(), uf: "AL", nome: "Alagoas"));
      realm.add<Estado>(Estado(ObjectId(), uf: "AP", nome: "Amapá"));
      realm.add<Estado>(Estado(ObjectId(), uf: "AM", nome: "Amazonas"));
      realm.add<Estado>(Estado(ObjectId(), uf: "BA", nome: "Bahia"));
      realm.add<Estado>(Estado(ObjectId(), uf: "CE", nome: "Ceará"));
      realm.add<Estado>(Estado(ObjectId(), uf: "DF", nome: "Distrito Federal"));
      realm.add<Estado>(Estado(ObjectId(), uf: "ES", nome: "Espírito Santo"));
      realm.add<Estado>(Estado(ObjectId(), uf: "GO", nome: "Goiás"));
      realm.add<Estado>(Estado(ObjectId(), uf: "MA", nome: "Maranhão"));
      realm.add<Estado>(Estado(ObjectId(), uf: "MT", nome: "Mato Grosso"));
      realm.add<Estado>(
          Estado(ObjectId(), uf: "MS", nome: "Mato Grosso do Sul"));
      realm.add<Estado>(Estado(ObjectId(), uf: "MG", nome: "Minas Gerais"));
      realm.add<Estado>(Estado(ObjectId(), uf: "PA", nome: "Pará"));
      realm.add<Estado>(Estado(ObjectId(), uf: "PB", nome: "Paraíba"));
      realm.add<Estado>(Estado(ObjectId(), uf: "PR", nome: "Paraná"));
      realm.add<Estado>(Estado(ObjectId(), uf: "PE", nome: "Pernambuco"));
      realm.add<Estado>(Estado(ObjectId(), uf: "PI", nome: "Piauí"));
      realm.add<Estado>(Estado(ObjectId(), uf: "RJ", nome: "Rio de Janeiro"));
      realm.add<Estado>(
          Estado(ObjectId(), uf: "RN", nome: "Rio Grande do Norte"));
      realm
          .add<Estado>(Estado(ObjectId(), uf: "RS", nome: "Rio Grande do Sul"));
      realm.add<Estado>(Estado(ObjectId(), uf: "RO", nome: "Rondônia"));
      realm.add<Estado>(Estado(ObjectId(), uf: "RR", nome: "Roraima"));
      realm.add<Estado>(Estado(ObjectId(), uf: "SC", nome: "Santa Catarina"));
      realm.add<Estado>(Estado(ObjectId(), uf: "SP", nome: "São Paulo"));
      realm.add<Estado>(Estado(ObjectId(), uf: "SE", nome: "Sergipe"));
      realm.add<Estado>(Estado(ObjectId(), uf: "TO", nome: "Tocantins"));
      realm.add<Estado>(Estado(ObjectId(), uf: "EX", nome: "Exterior"));
      realm.add<Estado>(Estado(ObjectId(), uf: "T", nome: "Todos"));
    },
  );
  ...
  /// Método utilizado para verificar se uma transaction está aberta.
  static bool isTransactionOpen() => _transaction.isOpen;

  /// Método utilizado para encerrar o Realm.
  static void dispose() => _instance.close();
